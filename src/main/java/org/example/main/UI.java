...
public class UI {
    ...
    public void drawTitleScreen() {
        ...
        //SECOND SCREEN
            ...
            text = "Mode: " + (gp.keyH.mpHostMode ? "Host" : "Join");
            x = getXforCenteredText(text);
            y += gp.tileSize * 2;
            g2.drawString(text, x, y);
            if (gp.keyH.mpSelectionIndex == 0) {
                g2.drawString(">", x - gp.tileSize, y);
            }

            text = "Target: " + gp.hostAddress + ":" + gp.networkPort;
            x = getXforCenteredText(text);
            y += gp.tileSize;
            g2.drawString(text, x, y);
            if (gp.keyH.mpSelectionIndex == 1) {
                g2.drawString(">", x - gp.tileSize, y);
            }
